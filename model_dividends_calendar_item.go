...
// DividendsCalendarItem represents a dividends calendar item from Benzinga
type DividendsCalendarItem struct {
	...
	DividendPrior string `json:"dividend_prior,omitempty"`
	...
	EndRegularDividend bool `json:"end_regular_dividend,omitempty"`
