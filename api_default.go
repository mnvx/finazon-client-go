...
/*
DefaultApiService My Datasets
Returns a list of datasets available for the workspace
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return DatasetsResponseBody
*/
func (a *DefaultApiService) Reference(ctx context.Context) (DatasetsResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue DatasetsResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/my_datasets"
