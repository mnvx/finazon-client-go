...
// IPOItem represents an IPO item
type IpoItem struct {
	...
	// Initial filing date
	InitialFilingDate string `json:"initial_filing_date,omitempty"`
	// Date range that represents the insider lock up period
	InsiderLockupDate string `json:"insider_lockup_date,omitempty"`
	// Amount of days for the insider lockup period
	InsiderLockupDays int64 `json:"insider_lockup_days,omitempty"`
	// IPO type
	IpoType string `json:"ipo_type,omitempty"`
	// Last year income
	LastYrIncome float64 `json:"last_yr_income,omitempty"`
	// Last year income
	LastYrIncomeYear float64 `json:"last_yr_income_year,omitempty"`
	// Last year revenue
	LastYrRevenue float64 `json:"last_yr_revenue,omitempty"`
	// Last year revenue
	LastYrRevenueYear float64 `json:"last_yr_revenue_year,omitempty"`
	// Firm that lead the underwriting process
	LeadUnderwriters []string `json:"lead_underwriters,omitempty"`
	// Market cap at offer
	MarketCapAtOffer float64 `json:"market_cap_at_offer,omitempty"`
	...
	OfferingShares float64 `json:"offering_shares,omitempty"`
	// Amount of ordinary shares being offered
	OfferingSharesOrdAdr float64 `json:"offering_shares_ord_adr,omitempty"`
	// Number of shares being offered x price per share
	OfferingValue float64 `json:"offering_value,omitempty"`
	// Indicates if the predicted date has been verified by the company
	OpenDateVerified bool `json:"open_date_verified,omitempty"`
	// Ordinary shares out after offer
	OrdSharesOutAfterOffer float64 `json:"ord_shares_out_after_offer,omitempty"`
	// Additional firms that were a part of the underwriting
	OtherUnderwriters []string `json:"other_underwriters,omitempty"`
	...
	PriceOpen float64 `json:"price_open,omitempty"`
	// Public offering price
	PricePublicOffering float64 `json:"price_public_offering,omitempty"`
	// Pricing date
	...
	// SIC
	Sic float64 `json:"sic,omitempty"`
	// ISs Spac converted to target
	SpacConvertedToTarget bool `json:"spac_converted_to_target,omitempty"`
	// State location
	...
	UnderwriterQuietExpirationDate string `json:"underwriter_quiet_expiration_date,omitempty"`
	// Days of expiration for the underwriter quiet period
	UnderwriterQuietExpirationDays int64 `json:"underwriter_quiet_expiration_days,omitempty"`
