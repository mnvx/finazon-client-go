...
/*
ReferenceApiService Api usage
Returns a list of datasets with available API calls and limits.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ReferenceApiGetApiUsageOpts - Optional Parameters:
     * @param "Product" (optional.String) -  Product code
@return ApiUsageResponseBody
*/

type ReferenceApiGetApiUsageOpts struct {
    Product optional.String
}

func (a *ReferenceApiService) GetApiUsage(ctx context.Context, localVarOptionals *ReferenceApiGetApiUsageOpts) (ApiUsageResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ApiUsageResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api_usage"
...
/*
ReferenceApiService List of Finazon datasets
Returns a list of all datasets available at Finazon.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ReferenceApiGetDatasetsOpts - Optional Parameters:
     * @param "Code" (optional.String) -  Filter by Finazon&#x27;s dataset code
...
type ReferenceApiGetDatasetsOpts struct {
    Code optional.String
    Page optional.Int32
    PageSize optional.Int32
}

func (a *ReferenceApiService) GetDatasets(ctx context.Context, localVarOptionals *ReferenceApiGetDatasetsOpts) (DatasetsResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/datasets"
...
/*
ReferenceApiService List of crypto markets
Returns a list of supported crypto markets.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ReferenceApiGetExchangesCryptoOpts - Optional Parameters:
     * @param "Page" (optional.Int32) -  Specific page of a paginated result to be displayed
     * @param "PageSize" (optional.Int32) -  Number of items displayed per page in a paginated result
@return ExchangesCryptoResponseBody
*/

type ReferenceApiGetExchangesCryptoOpts struct {
    Page optional.Int32
    PageSize optional.Int32
}

func (a *ReferenceApiService) GetExchangesCrypto(ctx context.Context, localVarOptionals *ReferenceApiGetExchangesCryptoOpts) (ExchangesCryptoResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ExchangesCryptoResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/markets/crypto"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ExchangesCryptoResponseBody
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ReferenceApiService List of stock markets
Returns a list of supported stock markets.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ReferenceApiGetExchangesStocksOpts - Optional Parameters:
     * @param "Country" (optional.String) -  Filter by ISO 3166 alpha-2 code
     * @param "Name" (optional.String) -  Filter by market name
     * @param "Code" (optional.String) -  Filter by market identifier code (MIC) under ISO 10383 standard
     * @param "Page" (optional.Int32) -  Specific page of a paginated result to be displayed
     * @param "PageSize" (optional.Int32) -  Number of items displayed per page in a paginated result
@return ExchangesStocksResponseBody
*/

type ReferenceApiGetExchangesStocksOpts struct {
...
func (a *ReferenceApiService) GetExchangesStocks(ctx context.Context, localVarOptionals *ReferenceApiGetExchangesStocksOpts) (ExchangesStocksResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ExchangesStocksResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/markets/stocks"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ExchangesStocksResponseBody
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ReferenceApiService List of market centers
Returns a list of market centers.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return MarketCenterResponseBody
*/
func (a *ReferenceApiService) GetMarketCenter(ctx context.Context) (MarketCenterResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue MarketCenterResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sip/market_center"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MarketCenterResponseBody
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ReferenceApiService List of Finazon publishers
Returns a list of all publishers available at Finazon.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ReferenceApiGetPublishersOpts - Optional Parameters:
     * @param "Code" (optional.String) -  Filter by Finazon&#x27;s publisher code
     * @param "Page" (optional.Int32) -  Specific page of a paginated result to be displayed
     * @param "PageSize" (optional.Int32) -  Number of items displayed per page in a paginated result
@return PublishersResponseBody
*/

type ReferenceApiGetPublishersOpts struct {
    Code optional.String
    Page optional.Int32
    PageSize optional.Int32
}

func (a *ReferenceApiService) GetPublishers(ctx context.Context, localVarOptionals *ReferenceApiGetPublishersOpts) (PublishersResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PublishersResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/publishers"
...
/*
ReferenceApiService List of crypto pairs
Returns a list of cryptocurrency ticker symbols (pairs). This list is updated daily.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ReferenceApiGetSymbolsCryptoOpts - Optional Parameters:
     * @param "Dataset" (optional.String) -  Filter by Finazon&#x27;s dataset code
...
type ReferenceApiGetSymbolsCryptoOpts struct {
...
func (a *ReferenceApiService) GetSymbolsCrypto(ctx context.Context, localVarOptionals *ReferenceApiGetSymbolsCryptoOpts) (SymbolsCryptoResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SymbolsCryptoResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/tickers/crypto"
	...
	if localVarOptionals != nil && localVarOptionals.Dataset.IsSet() {
		localVarQueryParams.Add("dataset", parameterToString(localVarOptionals.Dataset.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SymbolsCryptoResponseBody
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ReferenceApiService List of forex ticker symbols
Returns a list of forex ticker symbols (pairs). This list is updated daily.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ReferenceApiGetSymbolsForexOpts - Optional Parameters:
     * @param "Ticker" (optional.String) -  Filter by ticker symbol
     * @param "Page" (optional.Int32) -  Specific page of a paginated result to be displayed
     * @param "PageSize" (optional.Int32) -  Number of items displayed per page in a paginated result
...
type ReferenceApiGetSymbolsForexOpts struct {
    Ticker optional.String
    Page optional.Int32
    PageSize optional.Int32
}

func (a *ReferenceApiService) GetSymbolsForex(ctx context.Context, localVarOptionals *ReferenceApiGetSymbolsForexOpts) (SymbolsForexResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SymbolsForexResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/tickers/forex"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SymbolsForexResponseBody
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ReferenceApiService List of stock ticker symbols
Returns a list of stock ticker symbols. This list is updated daily.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ReferenceApiGetSymbolsStocksOpts - Optional Parameters:
...
type ReferenceApiGetSymbolsStocksOpts struct {
    Cqs optional.String
    Cik optional.String
...
func (a *ReferenceApiService) GetSymbolsStocks(ctx context.Context, localVarOptionals *ReferenceApiGetSymbolsStocksOpts) (SymbolsStocksResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SymbolsStocksResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/tickers/stocks"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SymbolsStocksResponseBody
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ReferenceApiService List of US stock ticker symbols
Returns a list of US stock ticker symbols. This list is updated daily.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ReferenceApiGetSymbolsUSStocksOpts - Optional Parameters:
     * @param "Cqs" (optional.String) -  Filter by cqs symbol
     * @param "Cik" (optional.String) -  Filter by cik code
     * @param "Cusip" (optional.String) -  Filter by cusip code
     * @param "Isin" (optional.String) -  Filter by isin code
...
type ReferenceApiGetSymbolsUSStocksOpts struct {
    Cqs optional.String
    Cik optional.String
    Cusip optional.String
    Isin optional.String
...
func (a *ReferenceApiService) GetSymbolsUSStocks(ctx context.Context, localVarOptionals *ReferenceApiGetSymbolsUSStocksOpts) (SymbolsUsStocksResponseBody, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SymbolsUsStocksResponseBody
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/tickers/us_stocks"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SymbolsUsStocksResponseBody
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
